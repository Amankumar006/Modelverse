...
**Gemma 4 26B A4B IT** is a **Open Weights** model developed by **Google DeepMind**, released on **2026-04-02**. It is designed primarily for **Chat Reasoning** workloads. Featuring a **262K tokens** context window and **26B** parameter count, it offers robust performance for enterprise integration, developers, and researchers.
...
| Resource | Link |
|:---|:---|
| **Hugging Face** | [https://huggingface.co/google/gemma-4-26B-A4B-it](https://huggingface.co/google/gemma-4-26B-A4B-it) |
