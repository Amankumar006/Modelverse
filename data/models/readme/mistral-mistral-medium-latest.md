...
**Mistral Medium (latest)** is a **Open Weights** model developed by **Mistral AI**, released on **2026-04-29**. It is designed primarily for **Chat Reasoning** workloads. Featuring a **262K tokens** context window and **Undisclosed** parameter count, it offers robust performance for enterprise integration, developers, and researchers.
...
|:---|:---:|:---|
| **SWE-Bench Verified** | `77.6%` | Independent Eval |
...
| Resource | Link |
|:---|:---|
| **Hugging Face** | [https://huggingface.co/mistralai/Mistral-Medium-3.5-128B](https://huggingface.co/mistralai/Mistral-Medium-3.5-128B) |
