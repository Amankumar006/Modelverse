...
**Gemini Deep Research Preview** is a **Api Only** model developed by **Google DeepMind**, released on **2026-04-21**. It is designed primarily for **Image Generation** workloads. Featuring a **1.0M tokens** context window and **Undisclosed** parameter count, it offers robust performance for enterprise integration, developers, and researchers.
