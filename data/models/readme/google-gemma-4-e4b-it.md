...
**Gemma 4 E4B IT** is a **Open Weights** model developed by **Google DeepMind**, released on **2026-04-02**. It is designed primarily for **Chat Reasoning** workloads. Featuring a **131K tokens** context window and **Undisclosed** parameter count, it offers robust performance for enterprise integration, developers, and researchers.
...
| Resource | Link |
|:---|:---|
| **Hugging Face** | [https://huggingface.co/google/gemma-4-E4B-it](https://huggingface.co/google/gemma-4-E4B-it) |
