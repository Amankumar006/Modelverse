---
description: Add a new AI model entry to the Modelverse catalog. Prompts for required fields, then runs the add-model-entry skill end-to-end (duplicate check, validation, write, index update, summary).
---
