---
description: Urgent production fix for themodelverse.in — site down, broken rendering, bad data live, or security issue. Bypasses the normal review cadence but still requires user approval to merge.
---
