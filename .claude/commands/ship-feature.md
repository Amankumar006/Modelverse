---
description: Standard end-to-end cycle for shipping a non-urgent change (model entry, feature, fix) from a clean working tree to a ready-for-review PR with a Vercel preview URL.
---
