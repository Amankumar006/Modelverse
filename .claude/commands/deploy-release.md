---
description: Merge a reviewed PR to main, which deploys to themodelverse.in via Vercel. Requires explicit user approval. Spot-checks the live site after deploy and offers rollback if it fails.
---
