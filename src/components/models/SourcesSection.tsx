...
export default function SourcesSection({ sources, links, modelName }: SourcesSectionProps) {
  ...
  if (domainSources.length === 0) {
    return (
      <section id="sources" className="section-anchor space-y-4 pt-6 border-t border-[var(--muted)]/10">
  ...
  return (
    <section id="sources" className="section-anchor space-y-6 pt-6 border-t border-[var(--muted)]/10">
