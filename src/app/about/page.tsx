    ...
    <div className="bg-[var(--bg)] text-[var(--text)] min-h-screen relative font-sans select-none">
      ...
      <header className="relative h-[65vh] sm:h-[75vh] w-full flex justify-center items-center overflow-hidden border-b border-[var(--muted)]/10">
        ...
        >
          ...
          <h1 className="text-fluid-hero font-extrabold tracking-tight text-[var(--text)] leading-none">
            Modelverse
          </h1>
          <p className="text-fluid-base text-[var(--muted)] mt-4 max-w-xl font-medium">
      ...
      <section className="relative z-30 bg-[var(--bg)] px-6 md:px-12 py-16 md:py-24 text-center max-w-6xl mx-auto space-y-16">
        ...
        <p className="max-w-3xl mx-auto text-fluid-lg leading-relaxed text-[var(--text)] font-semibold">
        ...
        <div className="space-y-10 max-w-5xl mx-auto pt-10 text-left">
          <div className="text-center space-y-2">
            <h3 className="text-fluid-h2 font-extrabold tracking-tight text-[var(--text)]">The Curation Pipeline</h3>
            <p className="text-fluid-base text-[var(--muted)] max-w-xl mx-auto font-medium">
