slug: "qwen-3-8-flash-next-architecture-preview"
...
source_url: "https://qianwen-res.oss-accelerate.aliyuncs.com/Qwen3.8-Flash-Next/Qwen3.8-flash_banner_en.jpg#center"

cover_image: "PLACEHOLDER — no image uploaded yet. Source or create one, upload to public/images/articles/, and replace this path before publishing."
...
published_at: "2026-09-01T20:41:00+05:30"
...
August 26, 2026
Total Parameters
176B (125B MoE Backbone + 51B N-gram Table)
Active Parameters
6B per token
Context Window
262,144 tokens native (expandable to 1,000,000 with YaRN)
Modalities
Text, High-Resolution Vision, Multi-Frame Video
Licensing
Open Weights (Qwen License / Hugging Face & ModelScope)
Managed API Pricing
$0.15 / 1M Input Tokens, $0.47 / 1M Output Tokens (QwenCloud)
Key Benchmarks
SWE-bench Pro: 62.5% | DeepSWE 1.1: 58.7% | LiveCodeBench v6: 91.9% | GPQA Diamond: 91.7% | Toolathlon: 73.5%

Integration & API Usage
Developers can interface with Qwen3.8-Flash on QwenCloud using standard OpenAI-compatible client libraries:import os
